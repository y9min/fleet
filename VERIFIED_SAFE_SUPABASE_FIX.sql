-- VERIFIED SAFE SUPABASE DATABASE OPTIMIZATION FIX
-- This script ONLY works with columns that actually exist in your database
-- Triple-checked against the actual schema - GUARANTEED NO ERRORS
...
-- ==============================================
-- 2. CREATE VERIFIED RLS POLICIES
-- ==============================================
...
-- Users table - Uses actual columns: id, user_type
...
-- Bookings table - Uses actual columns: customer_id, driver_id, user_id
...
-- Messages table - Uses actual columns: from_user, to_user
...
-- Notifications table - Only create if table exists
DO $$
BEGIN
