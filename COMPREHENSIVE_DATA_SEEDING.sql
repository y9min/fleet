-- COMPREHENSIVE SUPABASE DATA SEEDING SCRIPT
-- This script creates ALL missing tables and data required for the application
...
CREATE INDEX IF NOT EXISTS idx_settings_name ON public.settings(name);
