-- FINAL CORRECTED USER MIGRATION - HANDLES UUID COLUMNS PROPERLY
-- This script migrates ALL users using only the columns that actually exist and handles UUID types correctly
...
-- Get the company ID and role IDs for foreign key references
DO $$
DECLARE
    company_uuid uuid;
...
BEGIN
    ...
    -- Using only columns that actually exist and handling UUID types correctly
    ...
    SELECT 
        ...
        'S', -- Super Admin
        super_admin_role_id, -- Use UUID role ID instead of integer
    ...
    SELECT 
        ...
        'O', -- Office Admin
        office_admin_role_id, -- Use UUID role ID instead of integer
    ...
    SELECT 
        ...
        'C', -- Customer
        customer_role_id, -- Use UUID role ID instead of integer
    ...
    SELECT 
        ...
        'D', -- Driver
        driver_role_id, -- Use UUID role ID instead of integer
