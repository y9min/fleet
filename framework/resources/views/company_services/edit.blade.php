    ...
    <div class="card card-warning">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('image', __('fleet.icon_img'), ['class' => 'form-label']) !!} (880px * 555px) @if($data->image != null) (<a href="{{ asset('uploads/'.$data->image) }}" target="blank">@lang('fleet.view')</a>) @endif
              <br>
