-- SIMPLE UUID PERMISSION FIX
-- This script directly fixes the UUID permission comparison error
-- Run this in Supabase SQL Editor to fix the login error

-- ==============================================
-- 1. COMPLETELY REMOVE ALL PERMISSION TABLES
-- ==============================================

-- Drop all permission-related tables in correct order (respecting foreign keys)
...
-- ==============================================
-- 2. CREATE PERMISSION TABLES WITH INTEGER IDs
-- ==============================================

-- Create roles table with integer ID
CREATE TABLE roles (
...
-- Create permissions table with integer ID
...
-- ==============================================
-- 4. CREATE ESSENTIAL PERMISSIONS
-- ==============================================
...
-- ==============================================
-- 6. ASSIGN SUPER ADMIN ROLE TO ALL USERS
-- ==============================================
...
SELECT 
    '✅ SIMPLE UUID PERMISSION FIX COMPLETE!' as status,
    'All permission tables recreated with integer IDs' as message,
...
SELECT 
    'TABLE STRUCTURES VERIFIED' as info,
    table_name,
    column_name,
    data_type
