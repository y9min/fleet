...
function migrateData() {
    ...
    try {
        ...
        if (empty($companies)) {
            ...
            foreach ($companies as $company) {
                $newId = generateUUID();
                $companyMapping[$company->id] = $newId;
    ...
    try {
        ...
        if (empty($vehicleTypes)) {
            ...
            foreach ($vehicleTypes as $type) {
                $newId = generateUUID();
                $vehicleTypeMapping[$type->id] = $newId;
    ...
    try {
        ...
        foreach ($vehicles as $vehicle) {
            $newId = generateUUID();
            $vehicleMapping[$vehicle->id] = $newId;
