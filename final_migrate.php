<?php
/**
 * Final Corrected Data Migration Script: Laravel to Supabase
 * 
...
function migrateData() {
    echo "🚀 Starting Final Corrected Supabase Data Migration...\n\n";
    ...
    try {
        ...
        foreach ($bookings as $booking) {
            ...
            // Use mapped foreign key IDs - CRITICAL: Use the mappings!
