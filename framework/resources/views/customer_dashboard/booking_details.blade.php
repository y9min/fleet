...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-sm text-dark active"><a href="{{ url('/booking_details') }}"
            aria-current="page">@lang('frontend.Booking_Details') </a></li>
@endsection
                            ...
                            <div class="col-8">
                                <div class="distance_map_content">
                                    ...
                                    <p class="distance_map_count">
                                        {{ $data->getMeta('total_kms') ? $data->getMeta('total_kms') . ' Miles' : 'NA' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12 ">
                                    <div class="booking_fare_details">
                                        <div class="booking_fare_title">
                                            <p class="fare_title">@lang('frontend.Mileage')(Miles)</p>
                                            <p class="fare_detail">
                ...
                <div class="booking_tab_content">
                    ...
                    ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div
                                        class="ongoing-detail booking_vehicle_marker  justify-content-end justify-content-sm-start justify-content-md-start justify-content-lg-start justify-content-xl-start">
                                        <div class="vehicle-maker">
                                ...
                                <div class="col-4">
                                    <div class="ongoing-detail">
                                        <div class="vehicle-maker">
                                            ...
                                            <p class="vehicle-info-detail text-center">
                                                No.{{ $vehicle->luggage ?? '-' }}</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="vehicle-maker">
                                            ...
                                            <p class="vehicle-info-detail">
                                                {{ isset($vehicle->mileage) ? ($vehicle->mileage??'-') . ' km' : ($vehicle->int_mileage??'-') . ' km' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4 mt-3">
                                    <div class="ongoing-detail">
                                        <div class="vehicle-maker">
                                            ...
                                            <p class="vehicle-info-detail text-center">No.{{ $v_type->seats ?? '-' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="driver_profile">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4 mb-4 mb-sm-0 mb-md-0 mb-lg-0 mb-xl-0"
                                        ...
                                        <div class="driver_contact_info" style="flex-wrap: wrap;display: flex;align-items: center;gap: 10px;">

                                          @php

                                            $rating_check=\App\Model\ReviewModel::where('booking_id',$data->id)->first();

                                          @endphp

           

                                         @if(($data && $data->ride_status == "Completed") && !isset($rating_check))


                                            <button id="addRating" 
                                                class="btn bg-light btn-icon btn-3 call_btn me-4" onclick="AddRating()"><span
                                                    class="fa fa-star text-warning"></span> Add Rating</button>
                                        ...
                                        <!-- Hidden star rating container -->
                                        <div class="stars text-md-start text-center" id="starContainer">
            ...
            @if ($data && $data->getMeta('ride_status') == 'Completed')
                <div class="col-6">
                    <div class="booking_btn_group justify-content-end">
                        <a class="btn btn-icon btn-3 receipt_btn d-flex align-items-center"
                            href="{{ url('bookings/receipt/' . $data->id) }}">
                            <span class="btn-inner--text">Receipt</span>
                            <span class="btn-inner--icon"><img
                                    src="{{ asset('assets/customer_dashboard/assets/img/svg/receipt.svg') }}"></span>
                        </a>
                    </div>
                </div>
                <div class="col-6">
                    <div class="booking_btn_group justify-content-start d-flex align-items-center">
                        <a class="btn btn-icon btn-3 invoice_btn" href="{{ url('bookings/invoice/' . $data->id) }}">
                            ...
                            <span class="btn-inner--icon"><img
                                    src="{{ asset('assets/customer_dashboard/assets/img/svg/receipt-text-check-outline.svg') }}"></span>
                        </a>
                    </div>
                </div>
            @endif
...
<script>
    ...
    $('.star').on('click', function() {
        ...
        // Alert only if rating is below 5
        if (selectedRating <= 5) {

            $.ajax({

                url: "{{ url('save-ratings') }}",
                type: "get",
                data: {
                    "booking_id": "{{ $data->id }}",
                ...
                success: function(data) {
                    ...
                    if (data.status == 100) {
                        ...
                        tblprint += `<div class="alert alert-success custom-alert" role="alert">
                                                   <strong style="color:white;">${data.message}</strong>
                                               </div>`;

                      $(".show-message").html(tblprint);
                          setTimeout(function() {
                              $(".show-message").html('');
                                location.reload();
                          }, 3000);
...
<script>
    ...
    function geocodeAddress(geocoder, map, startAddress, endAddress) {
        ...
        }, function(resultsStart, status) {
            if (status === 'OK') {
                var startLocation = resultsStart[0].geometry.location;
                geocoder.geocode({
                    'address': endAddress
                }, function(resultsEnd, status) {
                    if (status === 'OK') {
