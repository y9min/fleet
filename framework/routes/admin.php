...
// driver reports
    ...
    // Public token-based route for billing portal (accessible without authentication)
    Route::get('yamz/billing-portal/{token}', 'CompaniesController@generateBillingPortal')
