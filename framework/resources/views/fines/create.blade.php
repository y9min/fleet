    ...
    <div class="content-header">
        <div class="header-card">
            <div class="header-content">
                <h1><i class="fas fa-plus"></i> Add New Fine</h1>
                <div>
        ...
        <div class="main-card">
            ...
            <div class="card-body">
                <form action="{{ route('fines.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Row 1: Fine Type + Contravention Code -->
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    @foreach($fine_types as $category => $types)
                                        <optgroup label="{{ $category }}">
                                            @foreach($types as $code => $description)
                                                <option value="{{ $code }}" {{ old('fine_type') == $code ? 'selected' : '' }}>
                                                    {{ $code }} - {{ $description }}
                                                </option>
                                            @endforeach
                                        </optgroup>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contravention_code" id="contravention_code" class="form-control @error('contravention_code') is-invalid @enderror" value="{{ old('contravention_code') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="vehicle_id" id="vehicle_id" class="form-control @error('vehicle_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($vehicles as $vehicle)
                                        <option value="{{ $vehicle->id }}" data-reg="{{ $vehicle->license_plate }}" {{ old('vehicle_id') == $vehicle->id ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="date_issued" id="date_issued" class="form-control @error('date_issued') is-invalid @enderror" value="{{ old('date_issued') }}">
                                @error('date_issued')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="admin_fee" id="admin_fee" class="form-control @error('admin_fee') is-invalid @enderror" value="{{ old('admin_fee', 0) }}" step="0.01" min="0">
                                @error('admin_fee')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="date_logged" id="date_logged" class="form-control @error('date_logged') is-invalid @enderror" value="{{ old('date_logged', date('Y-m-d\TH:i')) }}" required>
                                @error('date_logged')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount_window_days" id="discount_window_days" class="form-control @error('discount_window_days') is-invalid @enderror" value="{{ old('discount_window_days') }}" min="0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="escalation_days" id="escalation_days" class="form-control @error('escalation_days') is-invalid @enderror" value="{{ old('escalation_days') }}" min="0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="escalation_multiplier" id="escalation_multiplier" class="form-control @error('escalation_multiplier') is-invalid @enderror" value="{{ old('escalation_multiplier', 1.5) }}" step="0.1" min="1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    ...
                                    <label for="evidence_file" class="file-upload-label">
                                        <i class="fas fa-upload"></i> Choose File (PDF, JPG, PNG)
                                    </label>
                                </div>
                                @error('evidence_file')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="calculation-display">
                        ...
                        <div class="calculation-item">
                            <span>Admin Fee:</span>
                            <span id="display-admin-fee">£0.00</span>
                        </div>
...
$(document).ready(function() {
    // Vehicle selection handling - auto-fill assigned driver
    $('#vehicle_id').change(function() {
        var vehicleId = $(this).val();
        
        if (vehicleId) {
            // Clear current driver selection
            $('#driver_id').val('');
            
            // Fetch assigned driver for the selected vehicle
            $.ajax({
                url: '{{ route("fines.get-driver-by-vehicle") }}',
                type: 'GET',
                headers: {
            ...
            // Clear driver selection if no vehicle selected
            $('#driver_id').val('');
        }
    });
    ...
    $('#evidence_file').change(function() {
        ...
        if (fileName) {
            ...
            $('.file-upload-label').html('<i class="fas fa-upload"></i> Choose File (PDF, JPG, PNG)');
        }
    });
});
</script>
