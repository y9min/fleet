...
Route::namespace ('api1')->middleware(['throttle'])->group(function () {
	...
	Route::post('booking_type', 'UsersApi@booking_type');
...
Route::namespace ('api1')->middleware(['throttle', 'auth:api','api_enable'])->group(function () {

	



	Route::post('/cancel-reason', 'UsersApi@cancel_reason');
...
Route::prefix('vendor')->namespace ('api1')->middleware(['throttle', 'auth:api','api_enable'])->group(function () {
